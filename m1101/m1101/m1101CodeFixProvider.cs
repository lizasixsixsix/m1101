...
namespace m1101
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(m1101CodeFixProvider)), Shared]
    public class m1101CodeFixProvider : CodeFixProvider
    {
        private const string title = "Make uppercase";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(m1101Analyzer.DiagnosticId); }
        }
